...
static NSString * const khello_world_android__hello_world_android_titaniumJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_hello_world_android_titaniumInjection
{
	...
	[html appendString:khello_world_android__hello_world_android_titaniumJavascript];
...
{
	// attempt to make well-formed HTML and inject in our hello_world_android__hello_world_android_titanium bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _hello_world_android_titaniumInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to hello_world_android__hello_world_android_titanium support.",url);
				}
			}
