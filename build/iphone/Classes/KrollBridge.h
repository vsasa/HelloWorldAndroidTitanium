...
@interface hello_world_android__hello_world_android_titaniumObject : KrollObject {
@private
...
@private
	...
	NSMutableDictionary *modules;
	hello_world_android__hello_world_android_titaniumObject *_hello_world_android_titanium;
	BOOL shutdown;
