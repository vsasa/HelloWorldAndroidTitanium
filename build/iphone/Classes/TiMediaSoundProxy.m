...
-(void)setAudioSessionMode:(NSNumber*)mode
{
	...
	NSLog(@"[WARN] 'hello_world_android__hello_world_android_titanium.Media.Sound.audioSessionMode' is deprecated; use 'hello_world_android__hello_world_android_titanium.Media.audioSessionMode'");
