...
//@interface hello_world_android__hello_world_android_titaniumObject : NSObject
//@end

@interface hello_world_android__hello_world_android_titaniumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[hello_world_android__hello_world_android_titaniumObject class]])
		{
			for (NSString *key in [[(hello_world_android__hello_world_android_titaniumObject*)o modules] allKeys])
			{
