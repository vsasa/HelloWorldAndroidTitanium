...
// in simulator we redefine to format for hello_world_android__hello_world_android_titanium Developer console
...
{\
	NSString * exceptionName = [@"org.hello_world_android_titanium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hello_world_android_titanium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIhello_world_android__hello_world_android_titaniumNativeItemNone = -1, 
	UIhello_world_android__hello_world_android_titaniumNativeItemSpinner = -2,
	UIhello_world_android__hello_world_android_titaniumNativeItemProgressBar = -3,
	
	UIhello_world_android__hello_world_android_titaniumNativeItemSlider = -4,
	UIhello_world_android__hello_world_android_titaniumNativeItemSwitch = -5,
	UIhello_world_android__hello_world_android_titaniumNativeItemMultiButton = -6,
	UIhello_world_android__hello_world_android_titaniumNativeItemSegmented = -7,
	
	UIhello_world_android__hello_world_android_titaniumNativeItemTextView = -8,
	UIhello_world_android__hello_world_android_titaniumNativeItemTextField = -9,
	UIhello_world_android__hello_world_android_titaniumNativeItemSearchBar = -10,
	
	UIhello_world_android__hello_world_android_titaniumNativeItemPicker = -11,
	UIhello_world_android__hello_world_android_titaniumNativeItemDatePicker = -12,
	
	UIhello_world_android__hello_world_android_titaniumNativeItemInfoLight = -13,
	UIhello_world_android__hello_world_android_titaniumNativeItemInfoDark = -14,
	
	UIhello_world_android__hello_world_android_titaniumNativeItemDisclosure = -15,
	
	UIhello_world_android__hello_world_android_titaniumNativeItemContactAdd = -16
};
